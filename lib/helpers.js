...
export async function getNewsSummaries({ maxResults = 1 } = {}) {
  ...
  const url = `https://www.googleapis.com/calendar/v3/calendars/${NEWS_CALENDAR_ID}/events?key=${API_KEY}&timeMin=${timeMin}&singleEvents=true&orderBy=updated&maxResults=${maxResults}&showDeleted=false`;

  console.log("Fetching news summaries from:", url);

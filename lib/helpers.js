...
export async function getNewsSummaries({ maxResults = 1 } = {}) {
  ...
  const url = `https://www.googleapis.com/calendar/v3/calendars/${NEWS_CALENDAR_ID}/events?key=${API_KEY}&singleEvents=true&orderBy=startTime&maxResults=${maxResults}&showDeleted=false`;
